...
axinset1 = ax.inset_axes([0.4,0.65,0.3,0.3])
...
ax10.axvspan(973, 1073, color=(0.9, 0.9, 0.9), label="op. temp.")

axinset101 = ax10.inset_axes([0.4,0.65,0.3,0.3])
axinset102 = ax10.inset_axes([0.07,0.25,0.3,0.3])
#axinset101.set_facecolor("none")
#axinset102.set_facecolor("none")
axinset101.axvspan(973, 1073, color=(0.9, 0.9, 0.9))
axinset102.axvspan(973, 1073, color=(0.9, 0.9, 0.9))

fig11, ax11 = plt.subplots(layout="constrained")
axinset111 = ax11.inset_axes([0.4,0.68,0.3,0.3])
axinset112 = ax11.inset_axes([0.07,0.3,0.3,0.3])
axinset111.set_facecolor("none")
axinset112.set_facecolor("none")

fig12, ax12 = plt.subplots(layout="constrained")

ylist, delta_G_list = case1(T_range, x, p_O2, P)
plt_element_case1 = ax.plot(T_range, ylist, label ="O$_{2(g)}$, Sr surf")
ax10.plot(T_range, ylist/0.4*100, label ="O$_{2(g)}$, Sr surf")
ax12.plot(T_range, ylist, label="x=0.4")
axinset101.plot(T_range, ylist/0.4*100)
ax8.plot(T_range, ylist, label="ref")
...
plt_element_case2, = ax.plot(T_range, ylist, label = "O$_{2(g)}$, Sr bulk")
ax10.plot(T_range, ylist/0.4*100, label = "O$_{2(g)}$, Sr bulk")
axinset102.plot(T_range, ylist/0.4*100, color = default_colors[1])
ax9.plot(T_range, ylist, label="ref")
...
plt_element_case3, =ax.plot(T_range, ylist, label ="O$_O^X$, Sr surf")
ax10.plot(T_range, ylist/0.4*100, label ="O$_O^X$, Sr surf")
...
plt_element_case4, = ax.plot(T_range, ylist, label ="O$_O^X$, Sr bulk")
ax10.plot(T_range, ylist/0.4*100, label ="O$_O^X$, Sr bulk")
...
ax7.plot(T_range, ylist, label="x=" + str(x))


ylist, delta_G_list, delta_oxygen_list = case4(T_range, x = 0.6, delta_oxygen_parameters=delta_oxygen_parameters)
ax7.plot(T_range, ylist, label = "x=0.6")
ylist, delta_G_list, delta_oxygen_list = case4(T_range, x = 0.8, delta_oxygen_parameters=delta_oxygen_parameters)
ax7.plot(T_range, ylist, label="x=0.8")


ylist, delta_G_list = case1(T_range, x, p_O2, P, sensitivity_shift= -0.5*ev2J_p_mol)
ax8.plot(T_range, ylist, label="shift = -0.5 eV")
ylist, delta_G_list = case1(T_range, x, p_O2, P, sensitivity_shift= -1*ev2J_p_mol)
ax8.plot(T_range, ylist, label="shift = -1 eV")
ylist, delta_G_list = case1(T_range, x, p_O2, P, sensitivity_shift= -1.5*ev2J_p_mol)
#ax2.plot(T_range, delta_G_list/ev2J_p_mol)
ax8.plot(T_range, ylist, label="shift = -1.5 eV")


ylist, delta_G_list = case2(T_range, x, p_O2, P, sensitivity_shift= -0.5*ev2J_p_mol)
ax9.plot(T_range, ylist, label="shift = -0.5 eV")
ylist, delta_G_list = case2(T_range, x, p_O2, P, sensitivity_shift= -1*ev2J_p_mol)
ax9.plot(T_range, ylist, label="shift = -1 eV")
ylist, delta_G_list = case2(T_range, x, p_O2, P, sensitivity_shift= -1.5*ev2J_p_mol)
ax9.plot(T_range, ylist, label="shift = -1.5 eV")
...
ylist, delta_G_list = case1(T_range, x, p_O2, P, sensitivity_shift=-0.69*ev2J_p_mol)
ax11.plot(T_range, ylist/0.4*100, label="O$_{2(g)}$, Sr surf")
axinset111.plot(T_range, ylist/0.4*100)

ylist, delta_G_list = case2(T_range, x, p_O2, P, sensitivity_shift=-0.69*ev2J_p_mol)
ax11.plot(T_range, ylist/0.4*100, label="O$_{2(g)}$, Sr bulk")
axinset112.plot(T_range, ylist/0.4*100, color = default_colors[1])

ylist, delta_G_list, delta_oxygen_list = case3(T_range, x=0.4, delta_oxygen_parameters=delta_oxygen_parameters, sensitivity_shift=-0.69*ev2J_p_mol)
ax11.plot(T_range, ylist/0.4*100, label="O$_O^X$, Sr surf")

ylist, delta_G_list, delta_oxygen_list = case4(T_range, x = 0.4, delta_oxygen_parameters=delta_oxygen_parameters, sensitivity_shift = -0.69*ev2J_p_mol)
ax11.plot(T_range, ylist/0.4*100, label= "O$_O^X$, Sr bulk")



ylist, delta_G_list = case1(T_range, 0.6, p_O2, P)
ax12.plot(T_range, ylist, label="x=0.6")
ylist, delta_G_list = case1(T_range, 0.8, p_O2, P)
ax12.plot(T_range, ylist, label="x=0.8")
...
ax11.set_xlabel("T[K]")
ax11.set_ylabel("$[V\'\'\'_{La}]_{eq}=x_{eq}$")
ax11.set_title("corrected for initial oxygen vacancies")

ax10.set_xlabel("T[K]", fontsize=14)
ax10.set_ylabel("Sr release in %", fontsize=14)

ax8.set_title("case 1: O2 energy sensitivity")
ax8.set_xlabel("T[K]")
ax8.set_ylabel("$[V\'\'\'_{La}]_{eq}=x_{eq}$")

ax9.set_title("case 2: O2 energy sensitivity")
ax9.set_xlabel("T[K]")
ax9.set_ylabel("$[V\'\'\'_{La}]_{eq}=x_{eq}$")

ax7.set_xlabel("T[K]")
ax7.set_ylabel("$[V\'\'\'_{La}]_{eq}=x_{eq}$")
ax7.set_title("case 4")

ax12.set_xlabel("T[K]")
ax12.set_ylabel("$[V\'\'\'_{La}]_{eq}=x_{eq}$")
ax12.set_title("case 1")
...
ax11.set_xlim(left=T_lower_bound,right=T_upper_bound+1)
ax11.set_ylim(0,)
ax11.legend(loc="upper left", facecolor="none")
ax11.xaxis.set_minor_locator(AutoMinorLocator())
ax11.yaxis.set_minor_locator(AutoMinorLocator())

ax10.set_xlim(left=T_lower_bound,right=T_upper_bound+1)
ax10.set_ylim(0,)
ax10.legend(loc="upper left", facecolor="none")
...
ax7.set_ylim(0,)
ax7.legend(loc="upper left", facecolor="none")
ax7.xaxis.set_minor_locator(AutoMinorLocator())
ax7.yaxis.set_minor_locator(AutoMinorLocator())

ax12.set_xlim(left=T_lower_bound,right=T_upper_bound+1)
ax12.set_ylim(0,)
ax12.legend(loc="upper left", facecolor="none")
ax12.xaxis.set_minor_locator(AutoMinorLocator())
ax12.yaxis.set_minor_locator(AutoMinorLocator())

ax8.set_xlim(left=T_lower_bound,right=T_upper_bound+1)
ax8.set_ylim(0,)
ax8.legend(loc="upper left", facecolor="none")
ax8.xaxis.set_minor_locator(AutoMinorLocator())
ax8.yaxis.set_minor_locator(AutoMinorLocator())

ax9.set_xlim(left=T_lower_bound,right=T_upper_bound+1)
ax9.set_ylim(0,)
ax9.legend(loc="upper left", facecolor="none")
...
axinset101.xaxis.set_minor_locator(AutoMinorLocator())
axinset101.yaxis.set_minor_locator(AutoMinorLocator())
axinset102.yaxis.set_minor_locator(AutoMinorLocator())
axinset102.xaxis.set_minor_locator(AutoMinorLocator())

axinset101.set_xlim(T_lower_bound, T_upper_bound+1)
axinset101.set_ylim(0,)
axinset102.set_xlim(T_lower_bound, T_upper_bound+1)
axinset102.set_ylim(0,)

axinset111.xaxis.set_minor_locator(AutoMinorLocator())
axinset111.yaxis.set_minor_locator(AutoMinorLocator())
axinset112.yaxis.set_minor_locator(AutoMinorLocator())
axinset112.xaxis.set_minor_locator(AutoMinorLocator())

axinset111.set_xlim(T_lower_bound, T_upper_bound+1)
axinset111.set_ylim(0,)
axinset112.set_xlim(T_lower_bound, T_upper_bound+1)
axinset112.set_ylim(0,)
...
secyax8 = ax8.secondary_yaxis("right", functions=(yaxconvert, yaxinvert))
secyax8.set_ylabel("% of initial Sr content $\\frac{100 \\cdot x_{eq}}{x_0}$")

secyax9 = ax9.secondary_yaxis("right", functions=(yaxconvert, yaxinvert))
secyax9.set_ylabel("% of initial Sr content $\\frac{100 \\cdot x_{eq}}{x_0}$")
...
secyax8.yaxis.set_minor_locator(AutoMinorLocator())
secyax9.yaxis.set_minor_locator(AutoMinorLocator())

plt.show()

fig.savefig(local_path + "figs/dry_air_conditions.png", dpi=300, transparent=True, format="png")
fig10.savefig(local_path + "figs/dry_air_conditions_presentation.png", dpi=300, transparent=True, format="png")
