...
def case1(T_range, x0=0.4, x_O2=0.21, x_CrO3 = 1e-3, P=1):
	...
	for T in T_range:
		delta_G = (E_LSCF_slab_Sr_vac_surf + 2*E_DFT_SrCrO4 - 2*chem_pot_CrO3(T, E_DFT_CrO3, P=1) - chem_pot_O2(T, E_DFT_O2, P=1) - E_LSCF_slab)/2
...
def case2(T_range, x0=0.4, x_CrO3 = 1e-3, P = 1):
	...
	for T in T_range:
		delta_G = (E_LSCF_slab_Sr_surf_O_sub_surf + 2*E_DFT_SrCrO4 - 2*chem_pot_CrO3(T, E_DFT_CrO3, P=1)- E_LSCF_slab)/2
		delta_G_list.append(delta_G)
...
def case3(T_range, x0= 0.4, x_chr_hyd = 1e-3, x_O2 = 0.21, x_H2O = 0.08, P=1):
    ...
    for T in T_range:
        ...
        mu_list.append(chem_pot_CrO2OH2(T, P=1))
        delta_G = (E_LSCF_slab_Sr_vac_surf + 2*E_DFT_SrCrO4 + 2*chem_pot_H2(T, E_DFT_H2, P=1)- (E_LSCF_slab + 2* chem_pot_CrO2OH2(T, P=1)))*1/2
        delta_G_list.append(delta_G)
